...
if(empty($search_result))
{
  ...
  echo "<a href='dashboard.php'><button class='btn btn-primary'>Back To Dashboard</button></a>";
  exit;
}
...
<h4 class="display-4">Search Result</h4>
  ...
  <table class="table">
  <tr><th>Course Name</th><th>Assigned By</th><th>Course Price</th><th>Action</th></tr>
<?php


foreach($search_result as $value)
{
  echo "<tr><td>$value[coursename]</td><td>$value[fullname]</td><td>$value[price]</td><td></td></tr>";
}
